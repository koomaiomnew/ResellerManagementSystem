      ...
      <div className="max-w-xl w-full bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 transition-all">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 gap-5">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5 ml-1">Shop Name</label>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5 ml-1">Shop URL</label>
